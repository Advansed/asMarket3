  ...
  export function ipayCheckout(order, successCallback, failureCallback, errorCallback) {
    ...
    function createIframe(order) {
      ...
      // РќР° Р±СѓРґСѓС‰РµРµ, СЂР°Р·СЂРµС€РµРЅРёРµ РїРѕР»РЅРѕСЌРєСЂР°РЅРЅРѕРіРѕ СЂРµР¶РёРјР° Р°Р№С„СЂРµР№РјР°
    ...
    function closeModal(e) {
      ...
      if (data.type === 'CLOSE') {
        ...
        document.body.removeChild(scrollWrapper); //РџРѕ РєРЅРѕРїРєРµ Р·Р°РєСЂС‹С‚РёСЏ СѓРґР°Р»СЏРµРј Р°Р№С„СЂРµР№Рј РёР· DOM-РґРµСЂРµРІР°
